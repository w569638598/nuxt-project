...
import enterpriseEWM from '~/assets/images/enterpriseEWM.png'
...
function addCustomerService() {
    ...
    const innerHtml = `
            <div class="customer-service-box-title">
                <div class="customer-service-box-title-icon"><img src=${customerService}></div>
                <div class="customer-service-box-title-text">联系客服</div>
            </div>
            <div class="customer-service-box-content">
                <img src=${enterpriseEWM}>
                <p>扫码添加商务</p>
            </div>
    `
...
class fetchFn {
  constructor(baseUrl = 'https://webapi.yinghuasuan.com') {
